...
class World(object):
    ...
    def __init__(self, blackboard=None):
        ...
        # Whether we're in the phase after kickoff where we're not allowed
        # in the centre circle.
        self.inKickOffWaitTime = False

        # Wherether we've finished dcc scan after being unpenalised.
        self.inUnpenaliseScanTime = False

        # Whether we are manually placed and should spin
        self.inManualPlacementSpinTime = False

        # A BehaviourRequest to perform at the end of this behaviour
        # processing cycle.
        self.b_request = None
