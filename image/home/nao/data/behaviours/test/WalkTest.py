...
class WalkTest(BehaviourTask):
    def init(self):
        ...
        self.current_state = Stand(self, timeToRun=10,
                                   initMessage="Crouched and ready to pounce.")
...
class Stand(TimedTask):
    def tick(self):
        ...
        request.actions.body = actioncommand.crouch()

    def transition(self):
        if self.timer.finished():
            return WalkForwardFast(self.parent, timeToRun=5,
                                   initMessage="Roadrunner")
        else:
            return self
...
class WalkForwardFast(TimedTask):
    def tick(self):
        request = self.world.b_request
        request.actions.body = actioncommand.walk(500, 0, 0)

    def transition(self):
        if self.timer.finished():
            return Back(self, timeToRun=5,
                        initMessage="You spin my world right round.")
        else:
            return self
...
class Left(TimedTask):
    def tick(self):
        request = self.world.b_request
        request.actions.body = actioncommand.walk(0, 500, 0)

    def transition(self):
        if self.timer.finished():
            return Right(self, timeToRun=5,
                         initMessage="You spin my world right round.")
        else:
            return self
...
class Turn(TimedTask):
    ...
    def transition(self):
        if self.timer.finished():
            return TurnRight(self, timeToRun=5,
                             initMessage="You spin my world right round.")
        else:
            return self
...
class TurnRight(TimedTask):
    ...
    def transition(self):
        if self.timer.finished():
            return ForwardLeft(self, timeToRun=5,
                               initMessage="You spin my world right round.")
        else:
            return self
...
class ForwardLeft(TimedTask):
    def tick(self):
        request = self.world.b_request
        request.actions.body = actioncommand.walk(500, 500, 0)

    def transition(self):
        if self.timer.finished():
            return BackLeft(self, timeToRun=5,
                            initMessage="You spin my world right round.")
        else:
            return self
...
class BackLeft(TimedTask):
    ...
    def transition(self):
        if self.timer.finished():
            return TurnForward(self, timeToRun=5,
                               initMessage="You spin my world right round.")
        else:
            return self
...
class TurnForward(TimedTask):
    def tick(self):
        request = self.world.b_request
        request.actions.body = actioncommand.walk(500, 0, HALF_TURN)

    def transition(self):
        if self.timer.finished():
            return TurnBack(self, timeToRun=5,
                            initMessage="You spin my world right round.")
        else:
            return self
...
class TurnBack(TimedTask):
    ...
    def transition(self):
        if self.timer.finished():
            return TurnLeft(self, timeToRun=5,
                            initMessage="You spin my world right round.")
        else:
            return self
...
class TurnLeft(TimedTask):
    def tick(self):
        request = self.world.b_request
        request.actions.body = actioncommand.walk(0, 500, HALF_TURN)

    def transition(self):
        if self.timer.finished():
            return TurnForwardLeft(
                self,
                timeToRun=5,
                initMessage="You spin my world right round."
            )
...
class TurnForwardLeft(TimedTask):
    ...
    def transition(self):
        if self.timer.finished():
            return TurnBackLeft(self, timeToRun=5,
                                initMessage="You spin my world right round.")
        else:
            return self
