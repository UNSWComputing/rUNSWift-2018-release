...
Allows a behaviour to request an override of the default eye behaviours.
To use this, simply import this module, and then call the override function
with a key and a color. Like so:
