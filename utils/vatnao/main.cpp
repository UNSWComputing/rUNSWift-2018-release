...
int main(int argc, char *argv[]) {
    ...
    string top_nnmc = vatnaoOptions["colour_cal_top"].as<string>();
    string bot_nnmc = vatnaoOptions["colour_cal_bot"].as<string>();
    try {
        ...
        AppAdaptor vatnaoApp = AppAdaptor(path, top_nnmc, bot_nnmc);
