class_<BehaviourRequest>("BehaviourRequest")
   ...
   .def_readwrite("goalieDiving", &BehaviourRequest::goalieDiving)
   .def_readwrite("secondsSinceLastKick", &BehaviourRequest::secondsSinceLastKick)
   ...
   .def_readwrite("role", &BehaviourRequest::role)
   .def_readwrite("playingBall", &BehaviourRequest::playingBall)
   .def_readwrite("needAssistance", &BehaviourRequest::needAssistance)
   .def_readwrite("isAssisting", &BehaviourRequest::isAssisting)
   .def_readwrite("isKickedOff", &BehaviourRequest::isKickedOff)
   .def_readwrite("isFollowing", &BehaviourRequest::isFollowing)
   .def_readwrite("kickoffSide", &BehaviourRequest::kickoffSide)
   .def_readwrite("wantCrazyBall", &BehaviourRequest::wantCrazyBall)
   .def_readwrite("behaviourHierarchy", &BehaviourRequest::behaviourHierarchy)
