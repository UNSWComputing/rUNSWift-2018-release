...
// Includes the robot pose, ball pos, ball vel, kind of like the SHARED_DIM
#define MAIN_DIM_EXCLUDING_ROBOTS_PER_TEAM 7

// Number of dimensions in the main distribution.
// Adds in robot poses of our n teammates.
#define MAIN_DIM 3 * (ROBOTS_PER_TEAM - 1) + MAIN_DIM_EXCLUDING_ROBOTS_PER_TEAM
